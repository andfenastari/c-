...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SCOLON = 14,                    /* SCOLON  */
  YYSYMBOL_COMMA = 15,                     /* COMMA  */
  YYSYMBOL_LPAREN = 16,                    /* LPAREN  */
  YYSYMBOL_RPAREN = 17,                    /* RPAREN  */
  YYSYMBOL_LSBRACK = 18,                   /* LSBRACK  */
  YYSYMBOL_RSBRACK = 19,                   /* RSBRACK  */
  YYSYMBOL_LCBRACK = 20,                   /* LCBRACK  */
  YYSYMBOL_RCBRACK = 21,                   /* RCBRACK  */
  YYSYMBOL_ID = 22,                        /* ID  */
  YYSYMBOL_NUM = 23,                       /* NUM  */
...
static const char *const yytname[] =
{
  ...
  "INT", "VOID", "WHILE", "FOR", "RELOP", "ADDOP", "MULOP", "ASSIGN",
  "SCOLON", "COMMA", "LPAREN", "RPAREN", "LSBRACK", "RSBRACK", "LCBRACK",
  "RCBRACK", "ID", "NUM", "ERROR", "$accept", "id", YY_NULLPTR
};
